...
--
-- VERSION: Compatible with INTEGER course_id and module_id
-- =====================================================
...
-- Step 2: Create module_progression_rules table with INTEGER IDs
...
-- Step 3: Create module_content_completion table with INTEGER module_id
...
BEGIN
    ...
    -- Count questions (handle potential type mismatch)
    SELECT COUNT(*) INTO v_question_count
    FROM quiz_questions
...
BEGIN
    ...
    RAISE NOTICE '   4. Configure admin reports';
    RAISE NOTICE '';
END $$;
