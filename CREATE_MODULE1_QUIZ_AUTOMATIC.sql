-- =====================================================
-- AUTOMATED MODULE 1 QUIZ CREATION - NO MANUAL EDITING NEEDED!
-- =====================================================
-- This script automatically finds Module 1 and creates all 20 quiz questions
...
BEGIN
    -- =====================================================
    -- STEP 1: Find Module 1 automatically
    -- =====================================================
    ...
    IF v_module_id IS NULL THEN
        RAISE EXCEPTION 'ERROR: Module 1 not found! Please create the AIFUND001 Module 1 first.';
    END IF;
    ...
    IF v_question_count > 0 THEN
        RAISE NOTICE '⚠️  Warning: % existing questions found. Deleting them first...', v_question_count;
        DELETE FROM quiz_questions WHERE module_id = v_module_id;
        RAISE NOTICE '✅ Deleted % old questions', v_question_count;
    END IF;
    
    -- =====================================================
    -- STEP 2: Insert all 20 quiz questions
    -- =====================================================
    ...
    RAISE NOTICE '🎉 Quiz creation complete! Module 1 is ready for students.';
...
-- =====================================================
-- Uncomment and run this to see all questions:
/*
SELECT 
    order_number,
...
-- =====================================================
-- ✅ AUTOMATIC QUIZ CREATION COMPLETE!
-- =====================================================
-- Total Questions: 20
-- Easy: 8 (40%)
-- Medium: 9 (45%)
