...
-- =====================================================
-- This script will:
-- 1. Check if quiz_questions table exists
-- 2. Drop it if it has wrong structure
-- 3. Recreate it with correct columns
-- 4. Insert all 20 questions
-- =====================================================
...
-- Step 2: Create quiz_questions table with correct structure
...
CREATE INDEX idx_quiz_questions_order ON quiz_questions(module_id, order_number);

-- Step 3: Create quiz_attempts table
...
-- Step 4: Insert all 20 quiz questions
DO $$
DECLARE
    v_module_id UUID;
