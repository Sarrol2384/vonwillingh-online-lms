...
BEGIN
    ...
    INSERT INTO modules (
        ...
        '<div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 40px; border-radius: 10px; margin-bottom: 30px;"><h1 style="margin: 0 0 15px 0;">🔍 Module 3: Google My Business & Local SEO</h1><p style="font-size: 1.2em; margin: 0;">Get Found When Customers Search Near You</p></div><h2>Why Google My Business is FREE Gold</h2><p>When someone searches for hardware store near me or best salon in Sandton, Google My Business puts YOUR business on the map - literally!</p><div style="background: #e8f5e9; border-left: 5px solid #4caf50; padding: 25px; margin: 30px 0; border-radius: 5px;"><h4 style="color: #2e7d32; margin-top: 0;">💰 Best Part: IT IS 100% FREE!</h4><p>No monthly fees, no hidden costs. Just free customers finding you on Google!</p></div><h3>Setting Up Your Google My Business</h3><ol style="line-height: 1.8; font-size: 1.1em;"><li>Go to google.com/business</li><li>Click Manage Now</li><li>Enter your business name and address</li><li>Verify with postcard or phone (Google will call/mail you)</li><li>Add photos, hours, description</li><li>Done! You are on Google Maps! 🎉</li></ol><div style="background: white; border: 1px solid #e0e0e0; border-radius: 10px; padding: 25px; margin: 30px 0;"><h4>🏪 Real Success Story: Nomsa Salon - Soweto</h4><p><strong>Before Google My Business:</strong> 5 walk-in customers per week</p><p><strong>After setting up (2 weeks later):</strong> 25 new customers from Google searches!</p><p><strong>Cost:</strong> R0</p><p><strong>Nomsa tip:</strong> I ask every happy customer to leave a Google review. Now I have 47 five-star reviews and I am the top salon in my area!</p></div><h3>Getting Great Reviews</h3><p>Reviews = Trust = More Customers!</p><ul style="line-height: 1.8;"><li>✅ Ask happy customers for reviews (show them how!)</li><li>✅ Respond to ALL reviews (good and bad)</li><li>✅ Keep responses professional and friendly</li><li>✅ Fix problems mentioned in negative reviews</li></ul>',
        'lesson',
        3,
        true
    );
