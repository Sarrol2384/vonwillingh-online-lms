-- =====================================================
-- SETUP COMPLETE - EXACT SCHEMA MATCH
-- =====================================================
...
-- Step 1: Create module_progression_rules table
...
-- Step 2: Create module_content_completion table
...
DECLARE
    ...
    v_module2_id UUID;
BEGIN
    -- Find the course (INTEGER) and modules (UUID)
    SELECT 
        c.id,
    ...
    IF v_module1_id IS NOT NULL THEN
        ...
        RAISE NOTICE '========================================';
        RAISE NOTICE 'Course ID: % (INTEGER)', v_course_id;
        RAISE NOTICE 'Module 1 ID: % (UUID)', v_module1_id;
        RAISE NOTICE 'Module 2 ID: % (UUID)', COALESCE(v_module2_id::text, 'Not found');
        RAISE NOTICE '';
        RAISE NOTICE 'Schema matched correctly:';
        RAISE NOTICE '  - course_id: INTEGER';
        RAISE NOTICE '  - module_id: UUID';
        RAISE NOTICE '  - student_id: UUID';
        RAISE NOTICE '  - enrollment_id: UUID';
        RAISE NOTICE '';
        ...
        RAISE NOTICE '';
        RAISE NOTICE 'Optional: To enable test mode (60 seconds), run:';
...
-- =====================================================
-- DONE! Schema matched exactly to your database
-- =====================================================
